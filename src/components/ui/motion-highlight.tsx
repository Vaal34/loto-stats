...
const MotionHighlight = React.forwardRef(<T extends string>(props: Omit<MotionHighlightProps<T>, 'ref'>, ref: React.ForwardedRef<HTMLDivElement>) => {
  const {
    children,
    value,
    defaultValue,
        ...
        ? controlledItems
          ...
          : render(
              React.Children.map(children, (child, index) => (
                <MotionHighlightItem key={index} className={'itemsClassName' in props ? (props.itemsClassName as string) : undefined}>
...
}) as <T extends string>(props: MotionHighlightProps<T> & { ref?: React.ForwardedRef<HTMLDivElement> }) => React.ReactElement
...
const MotionHighlightItem = React.forwardRef<HTMLDivElement, Omit<MotionHighlightItemProps, 'ref'>>((
  {
    children,
    id,
    value,
